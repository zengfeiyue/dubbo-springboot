...
public class JwtTokenAuthentication {
     ...
     * @param username
     */
    public static void addAuthentication(HttpServletResponse response, String username,List<GrantedAuthority> grantedAuthorities) {
     ...
     * @param username
     */
    public static String getToken(String username,List<GrantedAuthority> grantedAuthorities) {
